...
namespace ToDoApp.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemsID,ItemName,Description,DueDate,IsDone,Priority,ListID")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemsID,ItemName,Description,DueDate,IsDone,Priority,ListID")] Item item)
        {
            if (ModelState.IsValid)
            {
